...
var my_db_logger = {
  info: function (s) {
    console.log("LOCALDB info", s);
  },
  error: function (s) {
    console.log("LOCALDB error", s);
  },
  warn: function (s) {
    console.log("LOCALDB warn", s);
  },
  warning: function (s) {
    console.log("LOCALDB warning", s);
  },
  debug: function (s) {
    console.log("LOCALDB debug", s);
  }
};
